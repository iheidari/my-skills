...
- Each project's `CLAUDE.md` or `AGENTS.md` must name its Linear project; if missing, ask developer and add it.
...
- Be very strict about adding to a project's `CLAUDE.md` or `AGENTS.md`. Add only what is genuinely useful and necessary in most sessions.
- Domain detail, reasoning, and history go in README/docs/skills, not `CLAUDE.md` or `AGENTS.md`. When unsure, don't add it.
